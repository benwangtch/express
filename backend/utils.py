...
apartment_col = ['address', 'houseAge', 'totalFloors', 'parkingArea']
house_col = ['address', 'houseAge', 'landTransferArea', 'buildingTransferArea', 'floorAreaRatio']
building_col = ['address', 'houseAge', 'mainBuildingArea']
